...
function isThreeOne(cards)  
  ...
  table.sort(cards)  
  if cards[1] ==cards[2] == cards[3] then  
    return true,cards[1]
  elseif cards[2] == cards[3] == cards[4]
    return true,cards[2]
  end  
  return false  
end  
...
function isThreeTwo( cards )  
  ...
  table.sort(cards)  
  if cards[1] == cards[2] and cards[1] == cards[3] and cards[4] == cards[5] then
    return true,cards[1]
  elseif cards[1] == cards[2] and cards[3] == cards[4] and cards[4] == cards[5] then
    return true,cards[3]
  end  
  return false  
end  
...
function isAircraftWing(cards)  
  ...
  local other = {}
  for i=1,#cards-2 do
    if cards[i] == cards[i+1] and cards[i] == cards[i+2] then
      table.insert(three,cards[i])
      table.insert(three,cards[i])
      table.insert(three,cards[i])
    else
